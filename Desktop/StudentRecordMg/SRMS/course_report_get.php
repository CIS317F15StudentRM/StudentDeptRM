...
<div id="page" class="container">
  <div id="add_student_wrapper">
   ...
   <?php   if(!isset($_GET['major']) && !isset($_GET['coursecode'])){
...
<h1>Major <?php echo $major; ?> </h1>
		...
		<?php $coursecode =$_GET['coursecode']?>
    ...
    <div class="main">
      ...
      <br>
      <?php }?>
<?php echo "<a onclick=\"history.go(-1);return true;\"  class=\"button button-blue center\" ><span>BACK</span></a>";   ?></div>
    <!-- End add_student div --> 
  </div>
